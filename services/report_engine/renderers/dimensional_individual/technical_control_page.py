...
class DimensionalIndividualTechnicalControlPage:
    """
    Encerramento do relatório dimensional individual.

    Reúne:
    - conclusão técnica;
    - elaboração e revisão;
    - status do controle técnico;
    - áreas de assinatura / aprovação.

    O layout aceita textos e datas maiores sem depender de alturas
    rígidas que possam cortar conteúdo real.
    """
        ...
        *,
        ...
        if nok_count > 0:
            ...
            message = (
                ...
                "dimensional(is) fora dos limites especificados. "
                "As características correspondentes estão detalhadas "
                "na seção de resultados deste relatório."
            )
            ...
            message = (
                "Todas as características avaliadas encontram-se dentro "
                "dos limites especificados para esta inspeção dimensional."
            )
            ...
            message = (
                "Os resultados dimensionais obtidos estão consolidados "
                "neste relatório e devem ser considerados em conjunto "
                "com as condições de medição registradas e com o "
